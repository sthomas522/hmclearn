test_that("paper examples", {
  ...
  test3 <- c(-0.094743, -0.658245, -0.376502, 0.023214, -0.777225,
             -0.184837, -0.571265, 0.733553, -0.101126, 1.113663,
             0.237930, -0.190462, 0.927705, -1.005529, -0.370701)
  expect_equal(c3_hmc, test3)

  p3_hmc <- as.vector(round(psrf(fm3_hmc), 6))

  test3b <- c(0.999751, 0.999815, 1.002159, 1.000188, 0.999750,
              0.999788, 1.000229, 1.003680, 0.999750, 1.000384,
              1.000252, 1.000566, 1.001682, 0.999758, 1.003153)
