...
```{r, echo=TRUE}
summary(res, burnin=trunc(N*.3))
```

```{r, echo=TRUE, fig.width=6, fig.height=4}
mcmc_trace(res, burnin=trunc(N*.3), pars=c("beta0", "beta1"))
```
...
```{r, echo=TRUE, fig.width=6, fig.height=4}
beta.true <- fixef(fm1)
diagplots(res, burnin=trunc(N*.3), actual.mu=beta.true, cols=1:2)
```
