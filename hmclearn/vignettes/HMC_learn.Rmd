...
The efficiency of sampling in the standard HMC algorithm can be improved significantly in multivariate models when the parameters $(\theta_1, ..., \theta_k) \in \Theta$ have an orthogonal basis.  One common method of ensuring an orthogonal basis involves applying QR decomposition to the design matrix prior to applying HMC.  
