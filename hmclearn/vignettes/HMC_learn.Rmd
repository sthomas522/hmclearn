...
The full step $\epsilon$ in $\Theta$ is sandwiched by half-steps $\epsilon/2$ for $\pmb{p}$.  This solution, though slightly more complex than Euler approximations, provides a more accurate approximation of the solution over many samples.  
