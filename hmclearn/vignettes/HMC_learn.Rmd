...
In our prior example, we assigned a uniform prior to $\beta$.  To demonstrate the flexibility of the software, we specify a multivariate Normal prior with hyperparameter $B$.
